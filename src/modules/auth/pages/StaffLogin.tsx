    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm md:max-w-md">
        ...
        >
          ...
          <h1 className="text-xl md:text-2xl font-bold text-white">Vriddhi Portal</h1>
          <p className="text-slate-400 mt-1 text-sm md:text-base">Sign in to your dashboard</p>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  className="w-full pl-10 pr-4 py-2.5 md:py-3 min-h-[48px] rounded-lg bg-slate-800/50 border border-slate-700/30 text-white placeholder-slate-500 focus:outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/20 text-base"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-2.5 md:py-3 min-h-[48px] rounded-lg bg-slate-800/50 border border-slate-700/30 text-white placeholder-slate-500 focus:outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/20 text-base"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 min-h-[48px] rounded-lg bg-violet-600 hover:bg-violet-500 disabled:bg-slate-700 disabled:cursor-not-allowed text-white font-medium transition-colors flex items-center justify-center gap-2 text-base"
            >
              {isLoading ? (
