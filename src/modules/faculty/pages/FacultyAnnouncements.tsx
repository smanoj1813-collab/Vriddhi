      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">Send and manage notices to students</p>
          </div>
        </div>
        <button
      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          ...
          filtered.map(item => {
            ...
            return (
              <div key={item.id} className={`bg-slate-800/50 border rounded-2xl p-5 transition-all ${item.pinned ? 'border-amber-500/30 bg-amber-500/5' : 'border-slate-700/50 hover:border-slate-600'}`}>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-slate-300 text-sm mb-3 leading-relaxed">{item.message}</p>
                  ...
                  <div className="flex flex-col gap-1 shrink-0">
                    <button
                      ...
                      className={`p-2 rounded-lg transition-all ${item.pinned ? 'bg-amber-500/20 text-amber-400' : 'hover:bg-slate-700 text-slate-500'}`}
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 border border-slate-700 rounded-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setShowCompose(false)} className="p-1.5 rounded-lg hover:bg-slate-700 transition-colors">
