                      ...
                      <div className="px-4 pb-4 border-t border-slate-200 dark:border-slate-700 pt-4">
                              ...
                              {course.modules.map((mod: ParsedModule) => (
                                ...
                                >
                                  <div className="flex items-center justify-between mb-1">
                                    ...
                                    <span className="text-xs text-slate-500 dark:text-slate-400" title="Planned hours · classes at 50 min each">
                        ...
                        <div className="flex gap-2 mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                          ...
                          <button
                            ...
                            className="flex-1 px-3 py-2 rounded-lg text-xs bg-blue-100 text-blue-700 dark:text-blue-300 border border-blue-500/20 hover:bg-blue-100 dark:bg-blue-900/30 transition-all flex items-center justify-center gap-1"
                          >
