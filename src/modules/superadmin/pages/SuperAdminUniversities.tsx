          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-xl w-full max-w-md mx-4 p-6 shadow-2xl">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-slate-700 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors text-sm"
              >
                Cancel
              </button>
              <button
