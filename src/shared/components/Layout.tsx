...
const navItems: NavItem[] = [
  ...
  { label: "Academic Calendar", path: "/admin/academic-calendar", icon: <CalendarToday />, roles: ["admin", "principal"] },
  ...
  { label: "Academic Calendar", path: "/admin/academic-calendar", icon: <CalendarToday />, roles: ["hod", "principal"] },
