...
const navItems: NavItem[] = [
  ...
  { label: "Universal Bank", path: "/admin/universal-bank", icon: <QuestionAnswer fontSize="small" />, roles: ["admin", "principal"], section: "Assessment Tools" },
...
const principalNav: SidebarEntry[] = [
...

  {
    ...
    children: [
      ...
      { label: "Universal Bank", path: "/admin/universal-bank", icon: <QuestionAnswer fontSize="small" /> },
